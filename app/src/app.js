...
class HelloWorldServer {
    ...
    static generateRandomColor() {
        const r = (0, crypto_1.randomInt)(0, 256);
        const g = (0, crypto_1.randomInt)(0, 256);
        const b = (0, crypto_1.randomInt)(0, 256);
        return `#${r.toString(16).padStart(2, "0")}${g.toString(16).padStart(2, "0")}${b.toString(16).padStart(2, "0")}`;
    }
    // Determine a readable text color based on background color
    static determineReadableTextColor(bgColor) {
...
// Start the server
const server = http_1.default.createServer(HelloWorldServer.handleRequest);
server.listen(PORT, () => {
